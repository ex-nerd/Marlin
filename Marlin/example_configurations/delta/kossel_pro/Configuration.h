...
// Unlike other deltas, Kossel Pro requires inverted directions
...
//#define Z_PROBE_REPEATABILITY_TEST // Z-Probe Repeatability test is not supported in Deltas yet.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -23 // KosselPro actual: -22.919; Probe on: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -6  // KosselPro actual: -6.304; Probe on: -front +behind
  // Kossel Pro note: The correct value is likely -17.45 but I'd rather err on the side of
  // not giving someone a head crash. Use something like G29 Z-0.2 to adjust as needed.
  // Increase this if the first layer is too thin (remember: it's a negative number so increase means closer to zero).
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -17.25 // -below (always!)
...
//   #define Z_PROBE_END_SCRIPT "G1 Z10 F12000\nG1 X15 Y330\nG1 Z0.5\nG1 Z10" //These commands will be executed in the end of G29 routine.
  ...
  #define Z_PROBE_DEPLOY
    ...
    // Kossel Pro
    #define Z_PROBE_DEPLOY_1_X -105 // Move left but not quite so far that we'll bump the belt
    #define Z_PROBE_DEPLOY_1_Y 0
    #define Z_PROBE_DEPLOY_1_Z 100
    #define Z_PROBE_DEPLOY_1_FEEDRATE HOMING_FEEDRATE_X
    #define Z_PROBE_DEPLOY_2_X -110 // Move outward to position deploy pin to the left of the arm
    #define Z_PROBE_DEPLOY_2_Y -125
    #define Z_PROBE_DEPLOY_2_Z 100
    #define Z_PROBE_DEPLOY_2_FEEDRATE HOMING_FEEDRATE_X
    #define Z_PROBE_DEPLOY_3_X 45 // Move right to trigger deploy pin
    #define Z_PROBE_DEPLOY_3_Y -125
    #define Z_PROBE_DEPLOY_3_Z 100
    #define Z_PROBE_DEPLOY_3_FEEDRATE (HOMING_FEEDRATE_X/2)

    // Line up with bed retaining clip
    #define Z_PROBE_STOW_X     36
    #define Z_PROBE_STOW_Y     -122
    #define Z_PROBE_STOW_Z     75
    #define Z_PROBE_STOW_DEPTH 70
  #endif
...
// Some calculations from jcrocholl for DEFAULT_AXIS_STEPS_PER_UNIT
...
#define DEFAULT_RETRACT_ACCELERATION  9000   // E acceleration in mm/s^2 for retracts
